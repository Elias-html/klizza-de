...
const APP_NAME = "Basis";       // Name der App (Homescreen, Browsertab)
const HOME_TITLE = "Startseite"; // Was oben in der Kopfzeile auf dem Startbildschirm steht
...
function renderHome() {
  setHeader({ title: HOME_TITLE, showBack: false });
  setActiveNav("home");
  ...
  $app.innerHTML = `<div class="app-grid">${tiles}</div>`;
}
